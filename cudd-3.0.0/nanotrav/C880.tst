...
# /root/research/cudd-3.0.0/nanotrav/.libs/nanotrav -p 1 -ordering dfs -autodyn -automethod sifting -reordering sifting -drop ./nanotrav/C880.blif
# CUDD Version 3.0.0
...
Number of cache look-ups: 59180
Number of cache hits: 28645
Number of cache insertions: 30616
Number of cache collisions: 2553
...
Maximum resident size            =  7364K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1993
Swaps = 0
Input blocks = 0
Output blocks = 8
Context switch (voluntary) = 40
