...
# /root/research/cudd-3.0.0/nanotrav/.libs/nanotrav -p 1 -trav -autodyn -automethod group -drop -clauses -density -decomp -zdd ./nanotrav/s641.blif
# CUDD Version 3.0.0
...
Number of cache hits: 38970
Number of cache insertions: 64731
Number of cache collisions: 10817
Number of cache deletions: 40017
Cache used slots = 21.21% (expected 21.38%)
...
Maximum resident size            =  8164K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 2045
Swaps = 0
Input blocks = 0
Output blocks = 88
Context switch (voluntary) = 37
Context switch (involuntary) = 855
