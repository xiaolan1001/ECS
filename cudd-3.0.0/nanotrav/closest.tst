...
# /root/research/cudd-3.0.0/nanotrav/.libs/nanotrav -p 1 -reordering genetic -drop -closest ./nanotrav/closest.blif
# CUDD Version 3.0.0
...
Maximum resident size            =  7348K

Virtual memory limit             = unlimited (unlimited)
Major page faults = 0
Minor page faults = 1262
Swaps = 0
Input blocks = 0
Output blocks = 8
Context switch (voluntary) = 37
Context switch (involuntary) = 50
